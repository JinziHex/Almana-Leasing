...
Route::group(['namespace' => 'Front'],function(){
 ...
 Route::any('car/rental','CarController@carList')->name('car.rental');
 Route::any('car/search','CarController@searchCar')->name('car.search');
 Route::any('car/search/vtype/{id}','CarController@searchCar');
 Route::any('car/search/mktype/{id}','CarController@searchCarByBrand');
 Route::any('car/search/sort/{sort}','CarController@sortCar');
 
 Route::any('car/search/change-currency/{id}','CarController@changeCurrency');
 ...
 Route::any('car/detail/{id}','CarController@carDetail');
