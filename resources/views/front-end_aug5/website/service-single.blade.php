...
$getPath =  "/carrental/assets/uploads/banner/".$fetchBanner->page_banner_image;
}
@endphp
@php
		$fetchTitle = $fetchService->service_title;
...
<div class="banner" style="background-image: linear-gradient(120deg,#000000 0%,rgba(0,0,0,0) 53%),url('{{@$getPath}}')!important;">
	...
	<div class="container">
		<div class="banner-title" data-aos="zoom-in" data-aos-duration="1200">
			<h1>{{ @$splitTitle[0] }}</span> {{ @$splitTitle[1] }}</h1>
		...
		<div class="row service-elements">
			<div class="col-sm-12 col-md-8 col-lg-8" data-aos="fade-right" data-aos-duration="1500">
				...
				<div class="content-element">
					<p>{!! ucFirst(@$fetchService->service_description) !!}</p>
					<h4>{{ strtoupper(@$fetchService->service_content_title) }}</h4>
					<div class="col-sm-12 col-md-12 col-lg-12 carmaintainence">
						{!! @$fetchService->service_content_description !!}
					</div>
			...
			<div class="col-sm-12 col-md-4 col-lg-4" data-aos="zoom-in" data-aos-duration="1500">
				<div class="image-block">
					<img src="{{url('/assets/uploads/service/'.@$fetchService->service_image_1)}}" alt="">
				</div>
				<div class="image-block">
					<img src="{{url('/assets/uploads/service/'.@$fetchService->service_image_2)}}" alt="">
				</div>
			</div>
		</div>
