...
<title>{{ __('Rent Solutions')}}   &raquo; {{ __('Car Rental') }}</title>
...
<link rel="icon" href="{{URL::to('assets/front/themes/rental/images/favicon.gif')}}" sizes="32x32" />
<link rel="icon" href="{{URL::to('assets/front/themes/rental/images/favicon.gif')}}" sizes="192x192" />
<link rel="apple-touch-icon-precomposed" href="{{URL::to('assets/front/themes/rental/images/favicon.gif')}}" />
...
<script src="http://webprojects.hexeam.in/rentsolutions/assets/front/themes/rental/js/main_jQuery.js" type="text/javascript"></script> <!--jQuery--> 
...
<script src="{{URL::to('assets/front/website/jq/custom.js')}}"></script>
