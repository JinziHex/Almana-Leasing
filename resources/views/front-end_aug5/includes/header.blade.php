         ...
         <div class="container">
            <div class="menu-left">
               <div id="logo" class="car-list-pg " style="text-align:center;text-align: center;position: relative;z-index: 9999;left:-60px;">
                    <a href="{{route('web.index')}}"><img src="{{URL::to('assets/front/themes/rental/images/logo-old.png')}}" class=""></a>
                  ...
                  <div class="menu-header">
                     <div class="menu-header">
                        <ul id="menu-primary" class="menu">
                           ...
                           <!--<li id="menu-item-200" class="menu-item menu-item-type-post_type menu-item-object-page {{ (Request::is('contact-us') ? 'menu-item-home current-menu-item page_item page-item-134 current_page_item' : '') }} menu-item-200"><a href="{{route('contact-us')}}">{{ __('Contact Us') }}</a></li>07%2F25%2F2022
