     ...
     {{--  <link rel='stylesheet' id='rw_toprated-css'  href='http://css.rating-widget.com/wordpress/toprated.css?ck=Y2020M09D16&#038;ver=3.0.6' type='text/css' media='all' /> --}}
      ...
      <link rel="icon" href="{{URL::to('assets/front/themes/rental/images/favicon.png')}}" sizes="32x32" />
      <link rel="icon" href="{{URL::to('assets/front/themes/rental/images/favicon.png')}}" sizes="192x192" />
      <link rel="apple-touch-icon-precomposed" href="{{URL::to('assets/front/themes/rental/images/favicon.png')}}" />
