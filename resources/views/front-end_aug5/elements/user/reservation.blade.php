          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-5 car-single-txt">
              ...
              <div id="carSpecs" class="Specs carSpecs">
                ...
                <p><span>{{__('Pickup Address:')}} </span> {{__('Rental Solutions,')}} <br>{{__('D Ring Road,')}}<br> {{__('Doha, QATAR')}}</p>
                ...
                <p><span>{{__('Total Rate:')}} </span> {{$fetchBookings->book_total_rate}} {{$fetchBookings->currency_id}}</p>              
              </div>
            </div>
