        ...
        <div class="col-12 col-md-4">
          <div class="car-box1">
            <form action="{{ route('user.personal.info') }}" method="POST" style="height: 100%;position: relative;padding-bottom:199px;">
              ...
              <div class="titl">
                <h2>{{__($Modelss['Model_name'])}}  <small><i>{{__('or similar')}}</i></small></h2>
            ...
            @endforeach
              ...
              <!--<button id="specMorBtn" class="specMorBtn" type="button"><i class="fa fa-plus" aria-hidden="true"></i>{{__('View more')}}</button>-->
...
if(locale=='en')
      ...
      {
        $.each(res,function(city_loc_id,arabic_location_name){
                    $("#SelectLocation").append('<option value="'+city_loc_id+'">'+arabic_location_name+'</option>');
                });
      }
			else
			{
