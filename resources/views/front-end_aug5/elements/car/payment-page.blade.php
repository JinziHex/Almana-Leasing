   ...
   <div class="list-details row shadow" style="text-align: center;">
        ...
        <div class="col-12 col-md-12">
          ...
          <p class="txt">{{__('Billing Address')}}:{{$address1}}<br>{{$address2}}</p>
            <p class="txt">{{__('Location')}}: {{$cityName}},&nbsp; {{$lcationName}},&nbsp; {{$custZipcode}},&nbsp; {{$cntName}}</p>
          <p class="txt">{{__('Mobile Number')}}: {{$MobileNumber}}<br>{{__('Passport Number')}}:{{$custPassNumber}}<br>{{__('Qatar Id')}} : {{$custQatarId}}</p>
