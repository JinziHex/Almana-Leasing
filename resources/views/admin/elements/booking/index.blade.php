      ...
      <div class="card">
         ...
         @if(session('status'))
            ...
            <div class="table-responsive">
               @if(session('success'))
               <div class="alert alert-success" id="err_msg">
                  <p>{{session('success')}}<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button></p>
               </div>
               @endif
               <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                  <thead>
                     <tr>
                        ...
                        {{-- <th class="wd-15p">{{ __('Availability')}}</th>--}}
                  ...
                  <tr>
                     ...
                     {{--<td>@if($bkDetails->rdy_count!="0.0")  <p style="color:green;"> Available </p> @else <p style="color:red;">Rented Out</p>  @endif</td>--}}
                     <td>
