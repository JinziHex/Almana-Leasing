                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" required="required" value="{{$photo->photo_title}}" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" required="" name="album_id">
                                    ...
                                    <option value="{{$album->id}}" {{$album->id == $photo->album_id ? 'selected' : ''}}>{{ $album->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <img src="{{url('/assets/uploads/album/photo/'.$photo->photo_image)}}" width="50" height="50">
                                @endif
                            </div>
                        </div>
