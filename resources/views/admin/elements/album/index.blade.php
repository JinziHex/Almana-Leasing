...
<div class="row" style="min-height: 70vh;">
    <div class="col-md-12 col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{route('admin.albums.create')}}" class="btn btn-dark btn-block">{{ __('Add') }}</a><br>
                @if(session('status'))
                    ...
                    <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $key+1 }}</td>
                                <td>{{ $album->title }}</td>
                                <!--<td style="text-align: left; direction: rtl;"><img src="{{url('/assets/uploads/album/'.$album->photo)}}" width="30" height="30"></td>-->
                                <td>
                                    <a href="{{route('admin.albums.edit',[$album->id])}}" class="btn btn-sm btn-info"><i class="fa fa-pencil-square-o"></i>&nbsp;{{ __('Edit') }}</a>&nbsp;
                                    <a href="{{route('admin.albums.destroy',[$album->id])}}" class="btn btn-sm btn-danger frmsubmit" method="DELETE"><i class="fa fa-trash-o"></i>&nbsp;{{ __('Delete') }}</a>
                                </td>
                                </td>
                            </tr>
                            @endforeach
