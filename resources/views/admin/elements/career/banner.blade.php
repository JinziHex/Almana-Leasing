...
<div class="row" style="min-height: 70vh;">
   <div class="col-md-12">
      <div class="card">
         ...
         @endif
         <form action="{{route('admin.page-data.update')}}"  method="post"  enctype="multipart/form-data">
          @csrf
            @php
            $userId = Auth::user()->id;
            ...
            <div class="card-body">
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        <label class="form-label">{{ __('Banner Title (Arabic)') }}</label>
                        <input type="text" class="form-control" name="arabic_page_banner_title" required=""  dir="rtl" lang="ar" value="{{$fetchDetail->ar_page_banner_title}}">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        <label class="form-label">{{ __('Banner Description (Arabic)') }}</label>
                        <input  type="text" class="form-control" name="arabic_page_banner_description" dir="rtl" lang="ar" value="{{$fetchDetail->ar_page_banner_description}}" >
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
