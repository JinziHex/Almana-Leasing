      ...
      <div class="card">
         ...
         @endif
          @if(session('status'))
                     ...
                     @endif 
         <form name="coupForm" action="{{route('coupon.update')}}" method="POST" enctype="multipart/form-data">
            @csrf
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <label class="form-label">{{ __('Coupon Code')}}</label>
                         <input type="text" id="coupon_code" name="coupon_code"  class="form-control" value="{{old('coupon_code')??$coupon->coupon_code}}">
                     </div>
                  </div>
                  <div class="col-md-6">
                  <div class="form-group">
                        <label class="form-label">{{ __('Coupon Description')}}</label>
                         <textarea  class="form-control" name="coupon_description">{{old('coupon_description')??$coupon->coupon_description}}</textarea>
                     </div>
                  </div>
                 <div class="col-md-6">
                     <div class="form-group">
                        <label class="form-label">{{ __('Discount Type')}}</label>
                         ...
                         <select   id="discount_type" name="discount_type" class="form-control">
                             ...
                             <option value="1" @if($coupon->discount_type==1) selected @endif>Price Discount</option>
                             <option value="2" @if($coupon->discount_type==2) selected @endif>Percentage Discount</option>
                         </select>
                     </div>
                  </div>
                  <div class="col-md-6">
                  <div class="form-group">
                        ...
                        <input type="number" id="minimum_amount" name="minimum_amount"  class="form-control" value="{{$coupon->minimum_order_amount}}">
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        <label class="form-label">{{ __('End Date-Activation')}}</label>
                         <input type="date" class="form-control" id="end_date" name="end_date"  value="{{old('end_date')??$coupon->end_date}}">
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        <label class="form-label">{{ __('Status')}}</label>
                         ...
                         <select   id="discount_type" name="coupon_status" class="form-control">
                             
                             <option value="1" @if($coupon->is_active==1) selected @endif>Active</option>
                             <option value="2" @if($coupon->is_active==2) selected @endif>Inactive</option>
                         </select>
                     </div>
                  </div>
