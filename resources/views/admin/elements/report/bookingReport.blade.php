               ...
               <div class="row">
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="number" id="reference_id"  name="reference_id"  class="form-control" value="@isset($_GET['reference_id']){{$_GET['reference_id']}}@endisset" >
                     </div>
                  </div>

                  <div class="col-md-4">
                     <label>{{ __('From date')}}</label>
                        <input type="date" id="from_date" name="from_date" value="{{$_GET['from_date']??Helper::dateFormat()->toDateString()}}" class="form-control" >
                  </div>

                  <div class="col-md-4">
                     <label>{{ __('To Date')}}</label>
                        <input type="date" id="to_date" name="to_date" value="{{$_GET['to_date']??Helper::dateFormat()->toDateString()}}" class="form-control" >
                  </div>
                 ...
                 <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        <div class="col-md-12 col-sm-12">
                           <a href="{{route('admin.booking.report')}}" class="btn btn-block btn-primary">{{__('Reset')}}</a>
