                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="form-label">Service Content Title</label>
                       <input type="text" name="service_content_title"  value="{{$fetchDetail->service_content_title}}" class="form-control">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="form-label">Service Content Title (Arabic)</label>
                       <input type="text" name="ar_service_content_title" dir="rtl" lang="ar" value="{{$fetchDetail->ar_service_content_title}}" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <textarea rows="3" cols="3" class="form-control" name="service_content_description" >{{$fetchDetail->service_content_description}}</textarea> 
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <textarea rows="3" cols="3" class="form-control" name="ar_service_content_description" dir="rtl" lang="ar" >{{$fetchDetail->ar_service_content_description}}</textarea> 
