                     ...
                     <div class="form-group">
                       <label>{{ __('Customers')}}</label>
                           <select class="form-control" name="book_customers">
                              ...
                              <option value="{{$custDetails->customer_id}}" {{ $custDetails->customer_id == $customr ? 'selected' : '' }}>{{$custDetails->cust_fname}}{{$custDetails->cust_lname}}</option>
                              @endforeach
                           </select>
                     </div>
                  </div>
                   ...
                   <div class="col-md-6">
                     <div class="form-group">
                       <label>{{ __('Complaint Type')}}</label>
                            ...
                            <option value="1" {{ $type == 1 ? 'selected' : '' }}>{{__('Complaint') }}</option>
                            <option value="2" {{ $type == 2 ? 'selected' : '' }}>{{ __('Suggestion') }}</option>
                           </select>
