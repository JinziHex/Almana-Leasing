         ...
         <div class="row">
            <div class="col-md-6">
               <div class="form-group">
                  <label>{{ __('Employee Code')}}</label>
                   <input type="text" id="employee_code"  name="employee_code"  class="form-control" value="@isset($_GET['employee_code']){{$_GET['employee_code']}}@endisset" >
               </div>
            </div>
            <div class="col-md-6">
               <div class="form-group">
                  <label>{{ __('Mobile Number')}}</label>
                   <input type="text" onkeypress='validate(event)' pattern="[1-9]{1}[0-9]{9}" id="mobile_number"  name="mobile_number"  class="form-control" value="@isset($_GET['employee_code']){{$_GET['mobile_number']}}@endisset" >
               </div>
            </div>
            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <input type="text" id="username"  name="user_name"  class="form-control"  value="@isset($_GET['employee_code']){{$_GET['user_name']}}@endisset" >
               </div>
            </div>
               <div class="col-md-6">
                  <div class="form-group">
