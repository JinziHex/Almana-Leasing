            ...
            <div class="table-responsive">
               <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                  ...
                  <tr>
                     ...
                     <td style="text-align: right; direction: rtl;"><img src="{{url('/assets/uploads/specifications/icons/'.$specDetails->spec_icon)}}" width="30" height="30">&nbsp;{{ucfirst($specDetails->ar_spec_name)}}</td>
                     <td>
