      ...
      <form action="{{route('specification.update')}}" method="POST" enctype="multipart/form-data" >
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label">{{ __('Specification Name (Arabic)')}} </label>
                <input type="text" id="ar_spec_name" dir="rtl" lang="ar" value="{{$resUpdate->ar_spec_name}}" name="ar_spec_name" required="required" class="form-control ">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
