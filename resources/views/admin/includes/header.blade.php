...
<div class="mobile-header">
  ...
  >
         ...
         <img src="{{URL::to('/assets/front-end/image/almana_leasing.png')}}" class="header-brand-img desktop-logo mobile-light" alt="logo">
         </a>
...
<div class="page-header">
   ...
   <div>
      <h1 class="page-title">{{ __('Almana Leasing ') }}</h1>
      <ol class="breadcrumb">
         <li class="breadcrumb-item"><a href="#">Almana Leasing </a></li>
