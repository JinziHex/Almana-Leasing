...
<aside class="app-sidebar">
  <div class="side-header" >
    ...
    <ul class="side-menu">
      ...
      <li class="slide">
        ...
        <ul class="slide-menu">
          ...
          <li><a class="slide-item" href="{{route('admin.promotions')}}">{{ ('Promotion') }}</a></li>
           <li><a class="slide-item" href="{{route('admin.customize.language.index')}}">{{ _('Lanaguage Customization') }}</a></li>
        </ul>
      </li>
      ...
      <li class="slide">
        <a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon ti-panel"></i><span class="side-menu__label">{{ ('Careers') }}</span><i class="angle fa fa-angle-right"></i></a>
        <ul class="slide-menu">
