 ...
 <div class="row summary-date">
  ...
  @foreach($coupons as $coupon)
              ...
              {{__('From')}} :{{$coupon->minimum_order_amount}}	QAR	
              	<a role="button" style="border-style: dotted;" class="btn btn-sm btn-outilne-success" onclick="myFunction('{{$coupon->coupon_code}}')" ><i><u>Click Here To Copy Coupon</u></i></a>
						</h2>
  ...
  @endforeach
        ...
        <div class="row bill-list">
          ...
          <div class="col-3"><input type="hidden" id="tot_amt" value="{{$total_rate}}"><p><input id="submitCoupon" type="button" class="btn btn-sm btn-danger"  class="form-control" value="{{__('APPLY')}}"></p></div>
        </div>
        <div class="row bill-list">
        <div class="col-6"></div>
