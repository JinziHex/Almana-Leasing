...
<div class="rental-wrapper car-list-pg car-single-pg car-summary-pg">
   <div class="filter-bar">
      <div class="container">
       <h2 style="margin: auto; margin-top: 10px; text-align: center; color: #000;">Booking Success</h2>
      </div>
   </div>
 ...
 <div class="list-details row shadow" style="text-align: center;margin-top: 0px;">
        <div class="col-12 Rental-Dtls">
          <h3>Booking Reference: {{$referenceId}}</h3>
        </div>
        <div class="col-12 col-md-12">
          <div class="mrgn">
          <p class="head">Hello, {{$Name}}</p>
          <!-- <p class="txt">Doha</p> -->
          </div>
          <div class="mrgn">
          <!-- <p class="head">Location</p> -->
          <p class="txt">Your payment has been successfully made and your booking is confirmed.</p>
          <!--<p class="txt">We have sent you an email with your booking details.</p>-->
          <p class="txt">Thank you for choosing us!</p><br>
           <a href="{{route('app.index')}}" class="btn btn-warning btn-lg btn-block mx-auto text-white">Back to Home</a>
          </div>
        </div>
