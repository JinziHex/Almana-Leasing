...
@section('content')
    <div class="login-wrapper signup-pg row mx-0">
      ...
      <div class="login-sec signup-sec row mx-0 shadow">
        ...
        <div class="col-md-12">
          <h3 class="mb-5 text-center">Reset Password - OTP Verify<br><small>Please enter the verification code that we've sent to your phone.
        ...
        <div class="col-md-12">
          ...
          <form action="{{route('customer.forgot-password.verify.otp')}}" method="GET" id="login-form" class="verify-sec row mx-0">
          	@csrf
