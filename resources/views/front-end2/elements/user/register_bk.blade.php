...
@endif
          <form action="{{route('user.save')}}" method="POST" id="login-form" class="row mx-0">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" id="FirstName" placeholder="Enter your First name" name="cust_fname" required value="{{ old('cust_fname') }}">
            </div>
            <div class="form-group col-md-6">
              <label for="LastName">Last Name</label>
              <input type="text" class="form-control" id="LastName" placeholder="Enter your Last name" name="cust_lname" required value="{{ old('cust_lname')}}">
            </div>
            ...
            {{--   <input type="hidden" class="form-control" id="MobileNumber" placeholder="" value="+971" name="cust_mobile_code">
              ...
              <input type="text" class="form-control" id="usermobile" placeholder="Enter mobile number" name="cust_mobile_number" value="{{ old('cust_mobile_number')}}" style="text-align: left;
padding-left: 80px;" required>
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" id="useremail" value="{{ old('email')}}" placeholder="Enter Email address" name="email" required>
            ...
            <div class="form-group col-md-6">
              ...
              <input type="password" class="form-control" id="password-confirm" placeholder="Enter Password again" required autocomplete="new-password" name="password_confirmation">
               <!--<span id="message"></span>-->
            </div>

            <div class="form-group col-md-6 date time-picker">
              <label for="DOB">Date of Birth </label>
              <input id="input_1_26" class="form-control" type="text" readonly="" placeholder="Enter Date of Birth" name="cust_dob" required="" value="{{ old('cust_dob')}}">
            </div>

            <div class="form-group col-md-6">
              <label for="QatarID">Qatar ID</label>
              <input type="text" class="form-control" id="QatarID" name="cust_qatar_id" value="{{old('cust_qatar_id')}}" placeholder="Enter Qatar ID" required>
            </div>

            <div class="form-group col-md-6">
              <label for="PassportNumber">Passport Number</label>
              <input type="text" class="form-control" id="PassportNumber" name="cust_passport_number" placeholder="Enter passport number" value="{{ old('cust_passport_number')}}" required>
            </div>

            <div class="form-group col-md-6 selectntn">
              <label for="Nationality">Nationality</label> <!--select2-->
            ...
            <button type="submit" id="submit1" class="mt-3 btn btn-warning btn-lg btn-block mx-auto text-white col-md-6">Sign up now</button>
          </form>
        </div>
