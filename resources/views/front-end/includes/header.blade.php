      ...
      <!-- HEADER STARTS -->
         <header class="sticky-top header-top logoimg">
      <div id="header" class="header-banner car-list-pg">
         <div class="container">
            <div class="menu-left">
               <div id="logo" class="car-list-pg " style="text-align:center;text-align: center;position: relative;z-index: 9999;">
                    <a href="{{route('web.index')}}">
                        @if(session()->get('locale')!=NULL)
                      @if(session()->get('locale')=='en')
                      <img src="{{URL::to('assets/front/themes/rental/images/almana_logo_en.png')}}"  style="width:225px;height:100px;">
                      @else
                       <img src="{{URL::to('assets/front/themes/rental/images/almana_logo_ar.png')}}"  style="width:225px;height:100px;">
                  ...
                  <div class="menu-header">
                     <div class="menu-header">
                        <ul id="menu-primary" class="menu">
                           <li id="menu-item-20" class="menu-item menu-item-type-post_type menu-item-object-page  menu-item-20"><a href="{{route('web.index')}}">{{__('Home')}}</a></li>
                           ...
                           <li id="menu-item-160" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-160"><a href="#">{{__('Services')}}</a></li>
                           <li id="menu-item-168" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-168"><a href="#">{{__('Offers')}}</a></li>-->
                           ...
                           <li id="menu-item-192" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-192"><a href="{{route('gallery.albums')}}">{{__('Gallery')}}</a></li>
                           <li id="menu-item-200" class="menu-item menu-item-type-post_type menu-item-object-page {{ (Request::is('contact-us') ? 'menu-item-home current-menu-item page_item page-item-134 current_page_item' : '') }} menu-item-200"><a href="{{route('contact-us')}}">{{ __('Contact Us') }}</a></li>
         ...
         <div class="menu-right">
               <div class="download-app">
                ...
                <div class="dropdown Choose headrlog pro-responsive">
          @if(Auth::guard('main_customer')->check())
    ...
    <i class="fa fa-chevron-right hide" aria-hidden="true"></i>    
               ...
               <div class="header-sidemenu">
                  <div class="menu-header">
                     <div class="menu-header">
                        <ul id="menu-primary" class="menu">
                            <li id="menu-item-200" class="actv menu-item menu-item-type-post_type menu-item-object-page {{ (Request::is('user/profile') ? 'menu-item-home current-menu-item page_item page-item-134 current_page_item' : '') }} menu-item-200"><a href="{{route('user.profile')}}">{{ __('Profile') }}</a></li>
                           <!--<li id="menu-item-20" class="menu-item menu-item-type-post_type menu-item-object-page  menu-item-20"><a href="http://rentsolutions.hexeam.in/">Home</a></li>
                           <li id="menu-item-108" class="menu-item menu-item-type-post_type menu-item-object-page {{ (Request::is('user/rental/history') ? 'menu-item-home current-menu-item page_item page-item-134 current_page_item' : '') }} menu-item-108"><a href="{{route('user.rental.history')}}">{{ __('Rental History') }}</a></li>
                           <li id="menu-item-160" class="menu-item menu-item-type-post_type menu-item-object-page {{ (Request::is('user/notifications') ? 'menu-item-home current-menu-item page_item page-item-134 current_page_item' : '') }} menu-item-160"><a href="{{route('user.notifications')}}">{{ __('Notifications') }}</a></li>
                           <li id="menu-item-168" class="menu-item menu-item-type-post_type menu-item-object-page {{ (Request::is('user/feedback') ? 'menu-item-home current-menu-item page_item page-item-134 current_page_item' : '') }} menu-item-168"><a href="{{route('user.feedback')}}">{{ __('Feedback') }}</a></li>
