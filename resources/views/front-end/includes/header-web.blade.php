                  ...
                  <div class="menu-header">
                     <div class="menu-header">
                        <ul id="menu-primary" class="menu">
                           ...
                           <li id="menu-item-108" class="menu-item menu-item-type-post_type menu-item-object-page {{ (Request::is('/car-rental') ? 'menu-item-home current-menu-item page_item page-item-134 current_page_item' : '') }} menu-item-108"><a href="/car/search?city_id=1&city_loc_id=2&from_date=<?php echo date('m/d/Y')?>&to_date=<?php echo date('m/d/Y', strtotime(' +1 day'))?>&pickup_time=10%3A00&return_time=10%3A00&cur_type=1">{{__('Car Rental')}}</a></li>
