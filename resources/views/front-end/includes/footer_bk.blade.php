      ...
      <div class="footer-wrap">
        <div class="ft1 blk-wrap">
          ...
          <ul>
            ...
            <li><a href="#">{{ ucFirst(@$fetchServices->service_title) }}</a></li>
            @endforeach
        ...
        <div class="ft2 blk-wrap">
          ...
          <ul>
            ...
            <li> <a href="#">Our Process and Packages</a></li>
                ...
                <div class="ft5 blk-wrap">
                  ...
                  <p>
                    ...
                    <!--<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-200"><a href="{{route('contact-us')}}">Contact</a></li>-->
                     <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-108"><a href="#">About Us</a></li>
                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-370"><a href="#">Car Rental</a></li>
                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-366"><a href="#">Services</a></li>
                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-168"><a href="#">Offers</a></li>
                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-365"><a href="#">Careers</a></li>
                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-200"><a href="#">Contact</a></li>
                  </ul></div>
                </div>
              </div>
            </div>
          ...
          <div id="footer">
            <div class="footer_copy">Copyright © <?php echo date('Y'); ?> Car Rental Company All Rights Reserved</div>
          </div>
        </div>
        <script>
