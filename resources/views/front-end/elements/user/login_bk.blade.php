...
@endif
        <form action="{{route('user.login')}}" method="POST" id="login-form1">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="InputMobile" placeholder="Enter Your Mobile Number" name="cust_mobile" required>
             @error('cust_mobile')
          ...
          <button type="submit" class="btn btn-warning btn-lg btn-block mx-auto text-white">{{ __('Log In') }}</button>
        </form>
      ...
      <div class="login-sec reg-sec">
        ...
        <div class="mt-4 why-reg row mx-0">
          ...
          <p>
            Save Time
            <small>Fastest pick up and drop off car rental</small>
          </p>
        </div>
        ...
        <div class="mt-4 why-reg row mx-0">
          ...
          <p>
            ...
            <small>Booking and reserving cars are even more faster to manage</small>
          </p>
        </div>
        ...
        <div class="mt-4 why-reg row mx-0">
          ...
          <p>
            Access Your Account
            <small>Anytime and wherever you are</small>
          </p>
        </div>
