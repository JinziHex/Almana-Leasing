  ...
  <div class="search-form">
    <form action="{{route('car.search')}}" method="GET" id="vehicle-search" class="row shadow mx-0">
      ...
      <div class="form-group col-md-6 date time-picker">
        <label for="FromDate">{{__('Pickup Date')}} </label>
      ...
      <div class="form-group col-md-6 date time-picker">
        <label for="ToDate">{{__('Return Date')}} </label>
      ...
      <button type="submit" id="carsearchbtn" form="vehicle-search" class="btn btn-warning btn-lg btn-block mx-auto text-white" style="margin-top: 70px;">{{__('Show Vehicles')}} </button>
    </div>
  </form>
</div>
