...
<div class="container">
	<div id="po-content" class="widecolumn">
		<div class="po-post" id="post-347">
			...
			<div class="po-entry">
				<h1 class="po-title">{{ __('Lease To Own') }}</h1>
				<p>{{__('The best alternative is lease to own its because of hassle free approvals with wide variety of vehicles. We operate Corporate Lease and own through dry leasing.')}}</p>
				<p>{{__('We take care of all your transportation requirements. Stop worrying about bank loans, eligibility problems, long procedures, documentations. We make sure that you have a hassle-free journey when you rent a car from Al Mana')}}</p>
