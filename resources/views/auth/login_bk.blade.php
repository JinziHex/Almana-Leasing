...
<html lang="en" dir="ltr">
   <head>
      <head>
         ...
         <!-- TITLE -->
         <title>{{ __('Hexmotors | Administration') }}</title>
         <!-- BOOTSTRAP CSS -->
         ...
         <div class="page">
            <div class="container">
               ...
               <div class="container-login100">
                     <div class=" div1" ><img src="{{URL::to('/assets/front-end/image/login-img-opt2.png')}}" class="login-img" alt=""></div>
                     
                     
                  <div class="wrap-login100  div2" >
                    <div class="text-center">  <img src="{{URL::to('/assets/front-end/image/almana_leasing.png')}}" class="img-logo" alt=""></div>
