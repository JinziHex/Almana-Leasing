...
<aside class="app-sidebar">
  <div class="side-header" >
    ...
    <ul class="side-menu">
      ...
      <li class="slide">
        <a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon fa fa-th-large"></i><span class="side-menu__label">{{ __('Masters') }}</span><i class="angle fa fa-angle-right"></i></a>
        <ul class="slide-menu">
          ...
          <li><a class="slide-item" href="{{route('admin.promotions')}}">{{ __('Promotion') }}</a></li>
           <li><a class="slide-item" href="{{route('admin.customize.language.index')}}">{{ __('Lanaguage Customization') }}</a></li>
        </ul>
      </li>
      ...
      <li class="slide">
        <a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon fa fa-pencil-square-o"></i><span class="side-menu__label">{{ __('Reports') }}</span><i class="angle fa fa-angle-right"></i></a>
        <ul class="slide-menu">
          <li><a class="slide-item" href="{{route('admin.customer.report')}}">{{ __('Customer Report') }}</a></li>
          <li><a class="slide-item" href="{{route('admin.booking.report')}}">{{ __('Booking Reports ') }}</a></li>
      ...
      <li class="slide">
        ...
        <li class="slide">
        <a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon fa fa-user-o"></i><span class="side-menu__label">{{ __('About Us') }}</span><i class="angle fa fa-angle-right"></i></a>
        <ul class="slide-menu">
        ...
        <li class="slide">
        <a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon fa fa-tasks"></i><span class="side-menu__label">{{ __('FAQ') }}</span><i class="angle fa fa-angle-right"></i></a>
        <ul class="slide-menu">
     ...
     <li class="slide">
        <a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon fa fa-cogs"></i><span class="side-menu__label">{{ __('Services') }}</span><i class="angle fa fa-angle-right"></i></a>
        <ul class="slide-menu">
    ...
    {{-- <li class="slide">
      ...
      <li class="slide">
        <a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon fa fa-commenting-o"></i><span class="side-menu__label">{{ __('Enquiries') }}</span><i class="angle fa fa-angle-right"></i></a>
        <ul class="slide-menu">
      ...
      <li class="slide">
        <a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon fa fa-cog"></i><span class="side-menu__label">{{ __('Settings') }}</span><i class="angle fa fa-angle-right"></i></a>
        <ul class="slide-menu">
