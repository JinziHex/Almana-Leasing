  ...
  <div class="side-header" >
    <a class="header-brand1" href="{{route('home')}}">
     {{--  <img src="{{URL::to('/assets/front-end/image/logo-white.png')}}" class="header-brand-img desktop-logo" alt="logo">
      ...
      <a aria-label="Hide Sidebar" class="app-sidebar__toggle ml-auto" data-toggle="sidebar" href="#">
    ...
    <ul class="side-menu">
      ...
      <li class="slide">
        <a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon ti-user"></i><span class="side-menu__label">{{ __('Masters') }}</span><i class="angle fa fa-angle-right"></i></a>
        <ul class="slide-menu">
      ...
      <li class="slide">
        <a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon ti-control-shuffle"></i><span class="side-menu__label">{{ __('Transactions') }}</span><i class="angle fa fa-angle-right"></i></a>
        <ul class="slide-menu">
