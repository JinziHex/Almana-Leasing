                          ...
                          <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <textarea rows="3" cols="3" class="form-control" name="service_description" required=""></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Service Description (Arabic)</label>
                                 <textarea rows="3" cols="3" class="form-control" name="ar_service_description" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <textarea rows="3" cols="3" class="form-control" name="service_content_description" required=""></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Service Content Description (Arabic)</label>
                                 <textarea rows="3" cols="3" class="form-control" name="ar_service_content_description" dir="rtl" lang="ar"
                                    required=""></textarea>
                                </div>
                            </div>
