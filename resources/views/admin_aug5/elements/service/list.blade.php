                        ...
                        <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p">{{ __('Service Description') }}</th>
                                    <th class="wd-15p">{{ __('Service Description (Arabic)') }}</th>
                                    ...
                                    <th class="wd-15p">{{ __('Service Content Title (Arabic)') }}</th>
                                    <th class="wd-15p">{{ __('Service Content Description') }}</th>
                                    <th class="wd-15p">{{ __('Service Content Description (Arabic)') }}</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($fetchDetail as $fetchDetails)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $fetchDetails->service_description }}</td>
                                        <td style="text-align: right; direction: rtl;">{{ $fetchDetails->ar_service_description }}</td>
                                        ...
                                        <td style="text-align: right; direction: rtl;">{{ $fetchDetails->ar_service_content_title }}</td>
                                        <td>{{ $fetchDetails->service_content_description }}</td> 
                                        <td style="text-align: right; direction: rtl;">{{ $fetchDetails->ar_service_content_description }}</td> 
                                        <td>
