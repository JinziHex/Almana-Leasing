             ...
             <div class="col-md-4">
                <div class="form-group">
                 <label>{{ __('Mobile Number')}}</label>
                      <input type="text" onkeypress='validate(event)' pattern="[1-9]{1}[0-9]{9}" id="reference_id"  name="cust_mobile_number"  class="form-control"  value="@isset($_GET['cust_mobile_number']){{$_GET['cust_mobile_number']}}@endisset"  maxlength="10">
                </div>
             </div>
             <div class="col-md-4">
                <div class="form-group">
                  <label>{{ __('Customer Name')}}</label>
                      <input type="text" pattern="[a-zA-Z\s]+" id="cname"  name="cust_name"  class="form-control" value="@isset($_GET['cust_name']){{$_GET['cust_name']}}@endisset" >
                </div>
             </div>
             <div class="col-md-4">
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="cust_otp_verify">
                   <option value="" selected  >All</option>
                    ...
                    <option  {{request()->input('cust_otp_verify') == "1" ? 'selected' : ''}}  value="1">Verifiled</option>
                   <option  {{request()->input('cust_otp_verify') ==  "0" ? 'selected' : ''}}  value="0">Not Verifiled </option>
