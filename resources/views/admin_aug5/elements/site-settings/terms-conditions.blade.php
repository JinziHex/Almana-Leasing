            ...
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{route('admin.page-data.update')}}" enctype="multipart/form-data">
              ...
              <div class="item form-group">
                <div class="col-md-6 col-sm-6 ">
                  <label class="col-form-label label-align" for="content-title">{{ __('Banner Title(English)')}}<span class="required">*</span></label>
                  
                  <input type="text" class="form-control" name="page_banner_title" required="" value="{{$fetchDetail->page_banner_title}}">
                </div>
                <div class="col-md-6 col-sm-6 ">
                  <label class="col-form-label label-align" for="content-title">{{ __('Banner Title(Arabic)')}}<span class="required">*</span></label>
                  
                  <input type="text" class="form-control" name="arabic_page_banner_title" required="" value="{{$fetchDetail->ar_page_banner_title}}">
                </div>
                <div class="col-md-6 col-sm-6 ">
                  <label class="col-form-label label-align" for="content-title">{{ __('Banner Description(English)')}}<span class="required">*</span></label>
                  
                  <input  type="text" class="form-control" name="page_banner_description" value="{{$fetchDetail->page_banner_description}}" >
                </div>
                <div class="col-md-6 col-sm-6 ">
                  <label class="col-form-label label-align" for="content-title">{{ __('Banner Description(Arabic)')}}<span class="required">*</span></label>
                  
                  <input  type="text" class="form-control" name="arabic_page_banner_description" value="{{$fetchDetail->ar_page_banner_description}}" >
                </div>
              </div>
              <div class="item form-group">
                <div class="col-md-12 col-sm-12 ">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  ...
                  <input type="text" class="form-control" name="arabic_page_title" required="" value="{{$fetchDetail->ar_page_title}}">
                </div>
                <div class="col-md-6 col-sm-6 ">
                ...
                <div class="col-md-6 col-sm-6 ">
                  ...
                  <textarea rows="8" cols="4" class="form-control" name="arabic_page_content" required="">{{$fetchDetail->ar_page_content}}</textarea> 
                </div>
              </div>
              <div class="item form-group">
                <div class="col-md-12 col-sm-12 ">
