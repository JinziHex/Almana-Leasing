                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                      <label>{{ __('Mobile Number')}}</label>
                           <input type="text" pattern="[1-9]{1}[0-9]{9}" onkeypress='validate(event)'  id="reference_id"  name="cust_mobile_number"  class="form-control"  placeholder="Enter valid Mobile Number" maxlength="10">
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
                       <label>{{ __('Customer Name')}}</label>
                           <input type="text" id="cname"   name="cust_name"  class="form-control"  >
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
