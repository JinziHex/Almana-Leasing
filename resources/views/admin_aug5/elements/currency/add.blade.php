      ...
      <div class="card">
         ...
         @endif
          @if(session('status'))
                     ...
                     @endif 
         <form action="{{route('admin.currency.save')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
               <div class="row">
                  <div class="col-md-4">
                     <div class="form-group">
                        <label class="form-label">{{ __('Currency Code') }}</label>
                           <input type="text" id="currency_code" name="currency_code" required="required" class="form-control ">
                     </div>
                  </div>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        <label class="form-label">{{ __('Currency Name') }}</label>
                           <input type="text" id="currency_name" name="currency_name" required="required" class="form-control">
                     </div>
                  </div>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        <label class="form-label">{{ __('Conversion Rate') }}</label>
                           <input type="number" id="currency_conversion_rate" name="currency_conversion_rate" step="0.01" required="" class="form-control">
                     </div>
                  </div>
