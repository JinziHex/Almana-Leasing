               ...
               <div class="row">
                  <div class="col-md-4">
                     <div class="form-group">
                         <label>{{ __('Reference Id')}}</label>
                          <input type="number" id="reference_id"  name="reference_id"  class="form-control" value="{{$refId}}" >
                     </div>
                  </div>

                  <div class="col-md-4">
                     <label>{{ __('From date')}}</label>
                        <input type="date" id="from_date" name="from_date" value="{{$frmDt}}" class="form-control" >
                  </div>

                  <div class="col-md-4">
                     <label>{{ __('To Date')}}</label>
                       <input type="date" id="to_date" name="to_date" value="{{$toDt}}" class="form-control" >
                  </div>
                     ...
                     <div class="form-group">
                       ...
                       <select class="form-control" name="customers">
                             ...
                             <option value="">--All Customers --</option>
                              ...
                              <option value="{{$custmLists->customer_id}}" {{ $custmLists->customer_id == $custId ? 'selected' : '' }}>{{$custmLists->cust_fname}} {{$custmLists->cust_lname}}</option>
                              @endforeach
                           </select>
                  ...
                  <div class="col-md-4">
                           ...
                           <select class="form-control" name="book_status">
                              ...
                              <option value="{{$bookStatuses->status_id}}" {{ $bookStatuses->status_id == $bkStatusss ? 'selected' : '' }}>{{$bookStatuses->status}}</option>
                              @endforeach
                           </select>
                        </div>
                        <div class="col-md-4">
               ...
               <table class="table table-striped table-bordered text-nowrap w-100">
                  ...
                  <tr>
                     ...
                     <td>
                         ...
                         @else
                         <button type="button" class="btn btn-dark btn-sm" data-toggle="modal" data-target=".bs-example-modal-lg{{$bkDetails->book_id}}">{{$bkDetails->status->status}}</button>
                         @endif
